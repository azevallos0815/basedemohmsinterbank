...
class SplashActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getToken() // TODO HMS clase para obtener el TokenId de Push Kit
        ...
        object : Thread() {
            override fun run() {
                try {
                    ...
                    val pushToken = HmsInstanceId.getInstance(this@SplashActivity).getToken(appId, "HCM")
                    if (!TextUtils.isEmpty(pushToken)) {
                        Config.setPushIdentifier(pushToken)
                    }
                } catch (e: Exception) {
